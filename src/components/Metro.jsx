  ...
  return (
    <div className="grid lg:grid-cols-2 sm:grid-cols-1 bg-white mx-auto max-w-6xl border-2 border-black border-t-0 ">
      ...
      <div className="mx-auto">
          ...
          <button className="bg-gray-800 w-[301px] h-[66px] text-white text-[22px] py-2 px-4  hover:bg-gray-300 mt-[24px] rounded-[40px] shadow-[6px_6px_0px_#000]">Explore our mentors</button>
